...
#define AD9834_FSYNC_SET    PAout(1)=1;
#define AD9834_FSYNC_CLR    PAout(1)=0; 
#define AD9834_SCLK_SET     PAout(2)=1;
#define AD9834_SCLK_CLR     PAout(2)=0;
#define AD9834_SDATA_SET    PAout(3)=1;
#define AD9834_SDATA_CLR    PAout(3)=0;
#define AD9834_RESET_SET    PAout(4)=0; 
#define AD9834_RESET_CLR    PAout(4)=1;
